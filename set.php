...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($connect,"insert into tbtest(fname,images) values('$_POST[fname]','$dst_db')");  // executing insert query
...
$records = mysqli_query($connect,"select * from tbtest"); // fetch data from database
...
?>
  <tr>
    ...
    <td><img src="./img/<?php echo $data['images']; ?>" width="100" height="100" ></td>
  </tr>	
<?php
}
?>
